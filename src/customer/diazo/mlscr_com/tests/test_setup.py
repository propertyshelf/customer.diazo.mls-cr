# -*- coding: utf-8 -*-
"""Test Setup of customer.diazo.mlscr_com."""
...
# local imports
from customer.diazo.mlscr_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++customer.diazo.mlscr_com/main.css',
]

JS = [
    '++resource++customer.diazo.mlscr_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for customer.diazo.mlscr_com."""

    layer = testing.CUSTOMER_DIAZO_MLSCR_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('ICustomerDiazoMlscrComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('ICustomerDiazoMlscrComLayer', layers)
